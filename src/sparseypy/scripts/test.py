...
#         True, 'rect', num_macs, 4, 4, int(num_macs ** 0.5),
#         int(num_macs ** 0.5), 0.4, 5, 5, 5, 5, 25,
...
#     x = torch.bernoulli(0.1 * torch.rand(batch_size, 25, 25)).float().cpu()
#     start = time.time()
...
# ax.set_title('Forward pass latency (batch size 1, input 5x5x5x5, # CMs: 4, # neurons: 4)')
